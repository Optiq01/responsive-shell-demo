...
@Component({
  selector: 'edge-chase-h-nudge-scale-input',
  templateUrl: './edge-chase-h-nudge-scale-input.component.html',
  styleUrls: ['./edge-chase-h-nudge-scale-input.component.css']
})
export class EdgeChaseHNudgeScaleInputComponent implements OnInit {
  ...
  public saveSelection():void{
    this.store.dispatch(new acn.SetEdgeChaseHNudgeScale(this.Size));
    this.closeFrame();
  }
