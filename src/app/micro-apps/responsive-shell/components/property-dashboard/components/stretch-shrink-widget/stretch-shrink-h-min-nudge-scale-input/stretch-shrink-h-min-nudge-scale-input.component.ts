...
@Component({
  selector: 'stretch-shrink-h-min-nudge-scale-input',
  templateUrl: './stretch-shrink-h-min-nudge-scale-input.component.html',
  styleUrls: ['./stretch-shrink-h-min-nudge-scale-input.component.css']
})
export class StretchShrinkHMinNudgeScaleInputComponent implements OnInit {
  ...
  public saveSelection():void{
    this.store.dispatch(new acn.SetStretchShrinkHMinNudgeScale(this.Size));
    this.closeFrame();
  }
