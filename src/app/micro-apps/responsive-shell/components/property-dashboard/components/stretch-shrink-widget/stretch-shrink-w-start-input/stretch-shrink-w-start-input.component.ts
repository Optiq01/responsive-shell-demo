...
@Component({
  selector: 'stretch-shrink-w-start-input',
  templateUrl: './stretch-shrink-w-start-input.component.html',
  styleUrls: ['./stretch-shrink-w-start-input.component.css']
})
export class StretchShrinkWStartInputComponent implements OnInit {
  ...
  public saveSelection():void{
    this.store.dispatch(new acn.SetStretchShrinkWStart(this.Size));
    this.closeFrame();
  }
