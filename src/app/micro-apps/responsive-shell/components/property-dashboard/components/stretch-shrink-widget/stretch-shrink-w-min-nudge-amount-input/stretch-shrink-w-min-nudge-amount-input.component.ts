...
@Component({
  selector: 'stretch-shrink-w-min-nudge-amount-input',
  templateUrl: './stretch-shrink-w-min-nudge-amount-input.component.html',
  styleUrls: ['./stretch-shrink-w-min-nudge-amount-input.component.css']
})
export class StretchShrinkWMinNudgeAmountInputComponent implements OnInit {
  ...
  public saveSelection():void{
    this.store.dispatch(new acn.SetStretchShrinkWMinNudgeAmount(this.Size));
    this.closeFrame();
  }
