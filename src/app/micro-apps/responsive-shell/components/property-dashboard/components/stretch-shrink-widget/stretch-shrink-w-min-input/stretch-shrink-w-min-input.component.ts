...
@Component({
  selector: 'stretch-shrink-w-min-input',
  templateUrl: './stretch-shrink-w-min-input.component.html',
  styleUrls: ['./stretch-shrink-w-min-input.component.css']
})
export class StretchShrinkWMinInputComponent implements OnInit {
  ...
  public saveSelection():void{
    this.store.dispatch(new acn.SetStretchShrinkWMin(this.Size));
    this.closeFrame();
  }
