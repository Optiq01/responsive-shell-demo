...
@Component({
  selector: 'chase-stop-h-nudge-scale-input',
  templateUrl: './chase-stop-h-nudge-scale-input.component.html',
  styleUrls: ['./chase-stop-h-nudge-scale-input.component.css']
})
export class ChaseStopHNudgeScaleInputComponent implements OnInit {
  ...
  public saveSelection():void{
    this.store.dispatch(new acn.SetChaseStopHNudgeScale(this.Size));
    this.closeFrame();
  }
